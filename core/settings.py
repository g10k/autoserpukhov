...
SECRET_KEY = 'nzn3$dt9x&amp;a&amp;n1^-#!tm6_9q0(8p86v-j57ep3o05q-+*23u&amp;f'
...
# TODO Изучить тесты.
# TODO Изучить комментарии, прикрепить.
# TODO Хорошо овладеть Ajax
# TODO Посмотреть рейтинги, которые вчера открыл для себя.
# TODO
